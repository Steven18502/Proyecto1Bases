...
namespace Proyecto1Bases.Controllers
{
    ...
    public class ClienteController: ControllerBase
    {
        ...
        {   
            ...
            var folder = "/home/chago/Documents/Bases/Proyecto1Bases/Facturas/";
            ...
            docxml.Load("/home/chago/Documents/Bases/Proyecto1Bases/Facturas/Plantilla.xml");           
            ...
            docxml.Save("/home/chago/Documents/Bases/Proyecto1Bases/Facturas/" + nombreArchivo + ".xml");

            // Se crea un mensaje email con el correo de salida y el de entrada
            MailMessage mmesage = new MailMessage("basesdatoss2@gmail.com","basesdatoss2@gmail.com");
            // Se edita la información que contiene el mensaje  y se agrega el xml
            mmesage.Subject = "Factura";
            mmesage.Body = "Factura Cine Tec";
            mmesage.Attachments.Add(new Attachment("/home/chago/Documents/Bases/Proyecto1Bases/Facturas/" + nombreArchivo + ".xml"));
            ...
            using (mS){
                ...
                mS.Close();
                // Se crea un mensaje email con el correo de salida y el de entrada
                MailMessage mm = new MailMessage("basesdatoss2@gmail.com","basesdatoss2@gmail.com");
